...
class QuestionModelTests(TestCase):
    ...
    # was_published_recently() returns False for questions whoes
    ...
    # was_published_recently() returns True for pub_date
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        # detail view of a question with pub_date in future returns
        # 404 not found
    ...
    def test_past_question(self):
        # detail view of question with pub_date in past displays question text
